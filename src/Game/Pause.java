...
public class Pause implements PaintListener, KeyListener
{
	...
	public Pause(Frame InFrame, Canvas PauseCanvas)
	{
	...
	public void createPause()
	{
		...
		ButtonList.add(new Button("Continue", Continue));
